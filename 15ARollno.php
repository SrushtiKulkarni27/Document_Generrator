...
<div class="subscribe-box"> 
    ...
    <form action="15 A form.php" method="GET" class="subscribe">
      <input type="text" placeholder="example 205109"name="rollno" value="<?php if(isset($_GET['rollno'])){echo $_GET['rollno'];}?>" autocomplete="off" required="required"/>
