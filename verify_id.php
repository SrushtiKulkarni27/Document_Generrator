...
<div class="subscribe-box"> 
    <h1>Enter ID to verify</h1>
    <form action="Verify.php" method="GET" class="subscribe">
      <input type="text" placeholder="example 101"name="Doc_Id" value="<?php if(isset($_GET['Doc_Id'])){echo $_GET['Doc_Id'];}?>" autocomplete="off" required="required"/>
