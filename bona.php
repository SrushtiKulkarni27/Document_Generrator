...
<head>
    ...
    <link rel="stylesheet" href="bona.css">
...
<div class="main-container">
  ...
  <img  align="left" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfxxqK3hsw85ajcSlhSpReKX_IDIJzPSElLqnd5oq-LNpgwmp0zrfnPLZnhl1kDoN4dcQ&usqp=CAU" width="160" height="150" alt="GPN Logo">
   <h1 ><center><b>Government Polytechnic,Nashik</b></center><h1>
    <h3 ><center>(An Autonomous Institute of Government of Maharashtra)<br>
                     ...
                     Email:office.gpnashik@dtemaharashtra.gov.in <br>
                     Web: www.gpnashik.ac.in<br></center></h3>
</div>
</div>
<br>
<hr><hr>
      ...
      if(isset($_POST['rollno']))
      {
        ...
        if(mysqli_num_rows($query_run)>0)
        {
            ...
            <p class="textindent">This is to certify that,Master/Miss <span class="x1" ><?= $row['name'];?></span>
                 is studying in our institute in the academic year <span class="x1" > <?= $row['academicYear'];?></span><per>
        ...
        ?>
         ...
         <select   style="font-size:20px;" style=" font-family: 'Times New Roman', Times, serif;" style="font-weight=bold;" id="mylist">
       ...
       <!-- <input type="search" list="mylist" class="no-outline">--></span> his/her request as per 
        application dated <span id="x1" STYLE="font-weight:bold"><?= $d=date("dS F Y");  ?></span>.
        </p> 
     

<div id="Div-Right">
<center>Registar<center>
